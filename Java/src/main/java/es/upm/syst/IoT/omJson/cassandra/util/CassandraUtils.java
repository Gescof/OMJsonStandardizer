package es.upm.syst.IoT.omJson.cassandra.util;
...
public class CassandraUtils {
	...
	public Session getSession() {
		...
		try {
			...
			cluster = Cluster.builder().addContactPoint(cassandraHost).withPort(cassandraPort)
					.withCredentials(cassandraUsername, cassandraPassword).withSSL(sslOptions).build();
